...
function Card({ className, ...props }: React.ComponentProps<"div">) {
  return (
    <div
        data-slot="card"
        className={cn(
          "bg-card text-card-foreground flex flex-col gap-0 rounded-xl border shadow-sm transition-transform duration-100 ease-out hover:shadow-lg cursor-pointer card-hover overflow-hidden",
          className
        )}
        {...props}
      />
