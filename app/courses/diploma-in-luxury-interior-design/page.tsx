      ...
      >
        ...
        <div className="relative z-10 text-center text-[var(--color-champagne-cream)] px-4 max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
           Diploma in Luxury Interior Design
          </h1>
          <p className="text-xl md:text-2xl">
            Learn the fundamentals of luxury interior design, including color theory, space planning, and advanced principles to create beautiful and functional spaces.
          </p>
        </div>
      </section>
