      ...
      >
        ...
        <div className="relative z-10 text-center text-[var(--color-champagne-cream)] px-4 max-w-4xl">
          <h1 className="text-4xl md:text-6xl font-bold mb-4">
            Advanced Diploma in Kitchen and Furniture Design
          </h1>
          <p className="text-xl md:text-2xl">
            Learn the fundamentals of kitchen and furniture design, including color theory, space planning, and advanced principles to create beautiful and functional spaces.
          </p>
        </div>
      </section>
                ...
                <CardContent className="p-6">
                  <div className="space-y-4">
                    <div className="border-t pt-4">
                      ...
                      <div className="flex justify-between mb-2">
                        <span>Sessions:</span>
                        <span>26 (3 sessions of 2 hrs per week)</span>
                      </div>
                      <div className="flex justify-between mb-2">
                        <span>Mode:</span>
                        <span>Online</span>
